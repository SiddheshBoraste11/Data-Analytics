...
INSERT INTO sales2023 VALUES (101,'iphone13', 'west','Raj', 50000);
INSERT INTO sales2023 VALUES (102,'macbookair', 'north','Priya', 85000);
INSERT INTO sales2023 VALUES (103,'ipadpro', 'south','Meera', 60000);
INSERT INTO sales2023 VALUES (104,'airpods', 'east', 'Neha',120000);
INSERT INTO sales2023 VALUES (105,'imac', 'west', 'Raj',120000);
INSERT INTO sales2023 VALUES (106,'macmini', 'north', 'Akash', 55000);
...
INSERT INTO sales2024 VALUES (201,'iphone13', 'west','Raj', 50000);
INSERT INTO sales2024 VALUES (202,'ipadpro', 'south','Meera', 62000);
INSERT INTO sales2024 VALUES (203,'applewatch', 'north','Priya', 30000);
INSERT INTO sales2024 VALUES (204,'macbookair', 'north', 'Priya',88000);
INSERT INTO sales2024 VALUES (205,'homepad', 'east', 'Neha',25000);
INSERT INTO sales2024 VALUES (206,'macstudio', 'west', 'Raj', 130000);

Select * FROM sales2024;
update sales2024 set salesperson = 'Priya' where sales_id = 204;
...
EXCEPT
 ...
 SELECT UPPER(country) AS upper_count
 FROM customers;     
 
 SELECT LOWER(country) AS lower_count
 FROM customers;    -------------/*lower = 'USA' to 'usa'*/
 
 SELECT TRIM(first_name) AS name
 FROM customers;  
 
 SELECT REPLACE(country,"USA", "CANADA") AS remaned
 FROM customers;    
 
 SELECT LENGTH(last_name) AS lengthof_lastname
 FROM customers;  
 
 SELECT 
    first_name,
    LEFT(first_name, 2) AS left_firstname,
    RIGHT(first_name, 3) AS right_firstname,
    SUBSTRING(first_name, 2, 3) AS sub_string
FROM
    customers;  
